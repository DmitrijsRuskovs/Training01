...
namespace Exercise7
{
    class Program
    {
        ...
        {
            Dog[] doggies = { 
                new Dog("Max","male"), new Dog("Rocky","male"), new Dog("Sparky","male"), 
                new Dog("Buster","male"), new Dog("Sam","male"), new Dog("Lady","female"), 
                new Dog("Molly","female"), new Dog("Coco","female"), new Dog("Mylo","bisexual cactus-lover") 
            };
